...
(function() {
    ...
    //Play speech variable
    var speech_sync_spawn, speech_text_cache = "", play_speech_func;
    ...
    function init_load_args() {
        ...
        program
            ...
            .option('-s, --play_speech', 'Say comments')
    ...
    function init_load_config() {
        ...
        util.Comment.cout([
            ...
            [lang.options[8].bold, lang.choices[run_config.settings.play_speech ? 1 : 0]],
        ...
        if(run_config.settings.play_speech) {
            speech_sync_spawn = require('child_process').spawnSync;
    ...
    function play_speech(text) {
        if (text !== speech_text_cache && run_config.settings.play_speech) {
